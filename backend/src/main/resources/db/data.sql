-- 카테고리 더미 데이터
INSERT INTO categories (name, sort_order, created_at) VALUES ('세차 샴푸', 1, CURRENT_TIMESTAMP);
INSERT INTO categories (name, sort_order, created_at) VALUES ('휠 클리너', 2, CURRENT_TIMESTAMP);
INSERT INTO categories (name, sort_order, created_at) VALUES ('유리 세정제', 3, CURRENT_TIMESTAMP);
INSERT INTO categories (name, sort_order, created_at) VALUES ('왁스/코팅제', 4, CURRENT_TIMESTAMP);
INSERT INTO categories (name, sort_order, created_at) VALUES ('타이어 드레싱', 5, CURRENT_TIMESTAMP);
INSERT INTO categories (name, sort_order, created_at) VALUES ('철분 제거제', 6, CURRENT_TIMESTAMP);
INSERT INTO categories (name, sort_order, created_at) VALUES ('기타', 7, CURRENT_TIMESTAMP);

-- 제품 더미 데이터 (user_id NULL = 관리자 등록)
INSERT INTO products (user_id, category_id, name, brand, description, price, capacity_ml, visibility, created_at, updated_at)
